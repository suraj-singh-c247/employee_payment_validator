        ...
        <>
            <form className='mb-3' onSubmit={(e) => onFunc(e)}>
                <div className="mb-3">
                    ...
                    <input type="file" name='employeeData' accept=".xlsx, .xls, .ods" className="form-control" onChange={(e) => onFileUpload(e, setEmployeeData)} />
                ...
                <div className="mb-3">
                    ...
                    <input type="file" name='paymentData' accept=".xlsx, .xls, .ods" className="form-control" onChange={(e) => onFileUpload(e, setPaymentData)} />
